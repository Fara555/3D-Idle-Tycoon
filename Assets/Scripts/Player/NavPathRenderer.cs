...
{
    [Header("Refresh")] public float refreshInterval = 0.06f;

    [Header("Ground")] public LayerMask groundLayers = ~0;
    public float offsetHeight = 0.03f;

    [Header("Arrows")]
    [Tooltip("Толщина линии, м.")]
    public float lineWidth = 0.08f;

    [Header("Behaviour")]
    public bool lockPhaseAtPathEnd = true;
