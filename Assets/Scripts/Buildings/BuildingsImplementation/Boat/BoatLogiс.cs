...
public class BoatLogiс : BuildingLogic, IWorkplace
{
	...
	public Vector3 GetWorkPoint() => workPoint.position;

	public virtual UTask PerformWork(Villager villager, CancellationToken ct)
	{
